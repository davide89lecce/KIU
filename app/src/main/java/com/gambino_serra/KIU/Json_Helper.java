...
public class Json_Helper {
    ...
    @SerializedName("disp_inizio")      public String disp_inizio;
    @SerializedName("disp_fine")        public String disp_fine;
    @SerializedName("tariffa_oraria")   public String tariffa_oraria;
    @SerializedName("pos_latitudine")   public Double pos_latitudine;
    @SerializedName("pos_longitudine")  public Double pos_longitudine;
